...
public class MissionInfo {
	...
	public MissionInfo(String[] serialAgentsNumbers, int duration, String gadget, String name, int timeExpired, int timeIssued) {
		this.serialAgentsNumbers = Arrays.asList(serialAgentsNumbers);
	}
